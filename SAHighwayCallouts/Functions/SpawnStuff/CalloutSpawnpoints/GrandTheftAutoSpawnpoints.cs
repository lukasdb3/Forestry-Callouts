...
namespace SAHighwayCallouts.Functions.SpawnStuff.CalloutSpawnpoints
{
    public class GrandTheftAutoSpawnpoints
    {
        ...
        internal static void RockfordHills(out Vector3 _spawnpoint, out float _heading, out Vector3 vicSpawnpoint, out float vicHeading)
        {
            Game.LogTrivial("-!!- SAHighwayCallouts - |GrandTheftAutoSpawnChooser| - Choosing Spawnpoint in RockfordHills Chunk!");
            _spawnpoint = default;
            _heading = default;
            vicSpawnpoint = default;
            vicHeading = default;
            var chose = new Random().Next(1, 2);
            Game.LogTrivial("-!!- SAHighwayCallouts - |GrandTheftAutoSpawnChooser| - Choosing Case: "+chose+" Out of 1 possible spawns!");
            switch (chose)
            {
                case 1:
        ...
        internal static void LaMesa(out Vector3 _spawnpoint, out float _heading, out Vector3 vicSpawnpoint, out float vicHeading)
        {
            Game.LogTrivial("-!!- SAHighwayCallouts - |GrandTheftAutoSpawnChooser| - Choosing Spawnpoint in LaMesa Chunk!");
            _spawnpoint = default;
            _heading = default;
            vicSpawnpoint = default;
            vicHeading = default;
        ...
        internal static void Davis(out Vector3 _spawnpoint, out float _heading, out Vector3 vicSpawnpoint, out float vicHeading)
        {
            Game.LogTrivial("-!!- SAHighwayCallouts - |GrandTheftAutoSpawnChooser| - Choosing Spawnpoint in Davis Chunk!");
            _spawnpoint = default;
            _heading = default;
            vicSpawnpoint = default;
            vicHeading = default;
        ...
        internal static void MissionRow(out Vector3 _spawnpoint, out float _heading, out Vector3 vicSpawnpoint, out float vicHeading)
        {
            Game.LogTrivial("-!!- SAHighwayCallouts - |GrandTheftAutoSpawnChooser| - Choosing Spawnpoint in MissionRow Chunk!");
            _spawnpoint = default;
            _heading = default;
            vicSpawnpoint = default;
            vicHeading = default;
