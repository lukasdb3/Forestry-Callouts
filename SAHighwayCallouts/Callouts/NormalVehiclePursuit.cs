...
{
    [CalloutInfo("NormalVehiclePursuit", CalloutProbability.Medium)]
    internal class NormalVehiclePursuit : Callout
    {
        #region Variables
        ...
        {
            CalloutMessage = "~o~Vehicle Pursuit";
            CalloutAdvisory = "~b~Dispatch:~w~ A vehicle is fleeing from law enforcement, Respond ~r~Code 3~w~";
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            SAHC_Functions.SpawnNormalCar(out _susV, _spawnpoint, _heading); //Spawns a normal vehicle to be pursued
            ...
            {
                LFunctions.BasicLogger(callout, "Passenger was created along with driver!");
