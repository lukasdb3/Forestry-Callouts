...
namespace ForestryCallouts2.Backbone.SpawnSystem.Land.CalloutSpawnpoints
{
    ...
    {                                                                                                                                                       
        ...
        {
            Log.Debug("ILLEGAL CAMP FIRE SPAWNPOINT CHOOSER", "Choosing spawnpoint in PaletoBayForest chunk");
            sSpawn = default;
            sHeading = 0f;
            fSpawn = default;
        ...
        {
            Log.Debug("ILLEGAL CAMP FIRE SPAWNPOINT CHOOSER", "Choosing spawnpoint in AltruistCampArea chunk");
            sSpawn = default;
            sHeading = 0f;
            fSpawn = default;
            var var = new Random().Next(1, 3);
        ...
        {
            Log.Debug("ILLEGAL CAMP FIRE SPAWNPOINT CHOOSER", "Choosing spawnpoint in RatonCanyon chunk");
            sSpawn = default;
            sHeading = 0f;
            fSpawn = default;
            var var = new Random().Next(1, 3);
