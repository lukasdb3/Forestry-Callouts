    ...
    internal class AnimalOnRoadway : Callout
    {
        ...
        public override void End()
        {
            ...
            if (!ChunkChooser.StoppingCurrentCall)
            {
                ...
                Game.DisplayNotification("3dtextures", "mpgroundlogo_cops", "Status", "~g~Animal On Roadway Code 4", "");
                CalloutInterfaceAPI.Functions.SendMessage(this, "Animal On Roadway Code 4");
            }
