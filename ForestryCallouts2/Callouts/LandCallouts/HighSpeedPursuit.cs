...
namespace ForestryCallouts2.Callouts.LandCallouts
{
    ...
    internal class HighSpeedPursuit : FcCallout
    {
        #region Variables

        internal override string CurrentCall { get; set; } = "HighSpeedPursuit";
        internal override string CurrentCallFriendlyName { get; set; } = "High Speed Pursuit";
